...
const BasicInfo: React.FC<any> = () => {
    ...
    return (
        <div>
            ...
            <hr></hr>
            <div> 
                <a href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=new" target="_blank" rel="noreferrer"><EmailIcon className={classes.footerIcon} /></a>
                <a href="https://www.linkedin.com/in/vivek-narasingaperumal-20633419a" target="_blank" rel="noreferrer"><LinkedInIcon  className={classes.footerIcon}/></a>
                <a href="https://github.com/vivebharath?tab=repositories" target="_blank" rel="noreferrer"><GitHubIcon  className={classes.footerIcon}/></a>
                <a href="https://www.instagram.com" target="_blank" rel="noreferrer"><InstagramIcon  className={classes.footerIcon}/></a>
                <a href="https://twitter.com" target="_blank" rel="noreferrer"><TwitterIcon  className={classes.footerIcon}/></a>
            </div>
        </div>
    );
};
